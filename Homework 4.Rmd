...
I hypothesize that fare price affected passenger survival as the fare price is related to the area of the ship that the passengers would be staying in changing their proximity to life boats and potentiall the cracks in the hull. 
...
##7 Compare automatic and purposeful selection
...
my.variables.nona$curvived=as.factor(my.variables.nona$survived)
...
#confusionMatrix(data=as.numeric(predictions>0.5),reference=my.variables.nona$survived)
